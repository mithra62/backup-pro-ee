...
<div id="file_backups">
	...
	?>
	<?php else: ?>
		<div class="no_backup_found"><?php echo $view_helper->m62Lang('no_file_backups')?> <a href="<?php echo $nav_links['backup_files']; ?>"><?php echo $view_helper->m62Lang('would_you_like_to_backup_files_now')?></a></div>
	<?php endif; ?>	
</div>
<br />
<?php if(count($backups['files']) != '0'): ?>
