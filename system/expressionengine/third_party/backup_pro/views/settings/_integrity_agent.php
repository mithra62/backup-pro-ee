...
<?php 
	...
	$this->table->add_row(
	    ...
	    form_input('db_verification_db_name', $form_data['db_verification_db_name'], 'id="db_verification_db_name"').$view_helper->m62FormErrors($form_errors['db_verification_db_name'])
	);
	$this->table->add_row(
	    ...
	    form_input('total_verifications_per_execution', $form_data['total_verifications_per_execution'], 'id="total_verifications_per_execution"').$view_helper->m62FormErrors($form_errors['total_verifications_per_execution'])
	);
	$this->table->add_row(
	    ...
	    form_checkbox('check_backup_state_cp_login', '1', $form_data['check_backup_state_cp_login'], 'id="check_backup_state_cp_login"').$view_helper->m62FormErrors($form_errors['check_backup_state_cp_login'])
	);
	echo $this->table->generate();
	$this->table->clear();	
?>
...
<?php 
	...
	$this->table->add_row(
	    ...
	    form_input('backup_missed_schedule_notify_email_interval', $form_data['backup_missed_schedule_notify_email_interval'], 'id="backup_missed_schedule_notify_email_interval"').$view_helper->m62FormErrors($form_errors['backup_missed_schedule_notify_email_interval'])
	);
	$this->table->add_row(
	    ...
	    form_textarea('backup_missed_schedule_notify_emails', $form_data['backup_missed_schedule_notify_emails'], 'id="backup_missed_schedule_notify_emails" data-placeholder="'.$view_helper->m62Lang('backup_missed_schedule_notify_emails').'"').$view_helper->m62FormErrors($form_errors['backup_missed_schedule_notify_emails'])
	);
	$this->table->add_row(
	...
	$this->table->add_row(
	    ...
	    form_input('backup_missed_schedule_notify_email_subject', $form_data['backup_missed_schedule_notify_email_subject'], 'id="backup_missed_schedule_notify_email_subject"').$view_helper->m62FormErrors($form_errors['backup_missed_schedule_notify_email_subject'])
	);
	$this->table->add_row(
	    ...
	    form_textarea('backup_missed_schedule_notify_email_message', $form_data['backup_missed_schedule_notify_email_message'], 'cols="90" rows="6" id="backup_missed_schedule_notify_email_message" ').$view_helper->m62FormErrors($form_errors['backup_missed_schedule_notify_email_message'])
	);
	echo $this->table->generate();
	$this->table->clear();	
?>
