...
<div>
	...
	$this->table->add_row(
	    ...
	    form_input('working_directory', $form_data['working_directory'], 'id="working_directory"').$view_helper->m62FormErrors($form_errors['working_directory'])
    );
	...
	$this->table->add_row(
	    ...
	    form_input('cron_query_key', $form_data['cron_query_key'], 'id="cron_query_key"').$view_helper->m62FormErrors($form_errors['cron_query_key'])
	);
	...
	$this->table->add_row(
	    ...
	    form_input('dashboard_recent_total', $form_data['dashboard_recent_total'], 'id="dashboard_recent_total"').$view_helper->m62FormErrors($form_errors['dashboard_recent_total'])
	);
	...
	$this->table->add_row(
	    ...
	    form_dropdown('auto_threshold', $threshold_options, $form_data['auto_threshold'], 'id="auto_threshold"' ).'<span id="auto_threshold_custom_wrap" style="display:none; ">'.
	       ...
	       .$view_helper->m62FormErrors($form_errors['auto_threshold'])
	       .$view_helper->m62FormErrors($form_errors['auto_threshold_custom'])
	);
	...
	$this->table->add_row(
	    ...
	    form_checkbox('allow_duplicates', '1', $form_data['allow_duplicates'], 'id="allow_duplicates"').$view_helper->m62FormErrors($form_errors['allow_duplicates'])
	);
	...
	$this->table->add_row(
	    ...
	    form_input('date_format', $form_data['date_format'], 'id="date_format"').$view_helper->m62FormErrors($form_errors['date_format'])
	);
	...
	$this->table->add_row(
	    ...
	    form_checkbox('relative_time', '1', $form_data['relative_time'], 'id="relative_time"').$view_helper->m62FormErrors($form_errors['relative_time'])
	);
