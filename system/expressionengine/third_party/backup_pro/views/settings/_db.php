...
<div>
	...
	$this->table->add_row(
	    ...
	    form_input('max_db_backups', $form_data['max_db_backups'], 'id="max_db_backups"').$view_helper->m62FormErrors($form_errors['max_db_backups'])
	);
	...
	$this->table->add_row(
	    ...
	    form_input('db_backup_alert_threshold', $form_data['db_backup_alert_threshold'], 'id="db_backup_alert_threshold"').$view_helper->m62FormErrors($form_errors['db_backup_alert_threshold'])
	);
	...
	$this->table->add_row(
	    ...
	    form_dropdown('db_backup_method', $db_backup_methods, $form_data['db_backup_method'], 'id="db_backup_method"').
	       ...
	       .$view_helper->m62FormErrors($form_errors['db_backup_method'])
	       .$view_helper->m62FormErrors($form_errors['mysqldump_command'])
	);
	...
	$this->table->add_row(
	    ...
	    form_input('php_backup_method_select_chunk_limit', $form_data['php_backup_method_select_chunk_limit'], 'id="php_backup_method_select_chunk_limit"').$view_helper->m62FormErrors($form_errors['php_backup_method_select_chunk_limit'])
	);
	...
	$this->table->add_row(
	    ...
	    form_dropdown('db_restore_method', $db_restore_methods, $form_data['db_restore_method'], 'id="db_restore_method"').
	       ...
	       .$view_helper->m62FormErrors($form_errors['db_restore_method'])
	       .$view_helper->m62FormErrors($form_errors['mysqlcli_command'])
	);
	...
	$this->table->add_row(
	    ...
	    .$view_helper->m62FormErrors($form_errors['db_backup_ignore_tables'])
	);
	...
	$this->table->add_row(
	    ...
	    .$view_helper->m62FormErrors($form_errors['db_backup_ignore_table_data'])
	);
	...
	$this->table->add_row(
	    ...
	    form_textarea('db_backup_archive_pre_sql', $form_data['db_backup_archive_pre_sql'], 'cols="90" rows="6" id="db_backup_archive_pre_sql"').$view_helper->m62FormErrors($form_errors['max_file_backups'])
	);
	...
	$this->table->add_row(
	    ...
	    form_textarea('db_backup_archive_post_sql', $form_data['db_backup_archive_post_sql'], 'cols="90" rows="6" id="db_backup_archive_post_sql"').$view_helper->m62FormErrors($form_errors['db_backup_archive_post_sql'])
	);
	...
	$this->table->add_row(
	    ...
	    form_textarea('db_backup_execute_pre_sql', $form_data['db_backup_execute_pre_sql'], 'cols="90" rows="6" id="db_backup_execute_pre_sql"').$view_helper->m62FormErrors($form_errors['db_backup_execute_pre_sql'])
	);
	...
	$this->table->add_row(
	    ...
	    form_textarea('db_backup_execute_post_sql', $form_data['db_backup_execute_post_sql'], 'cols="90" rows="6" id="db_backup_execute_post_sql"').$view_helper->m62FormErrors($form_errors['db_backup_execute_post_sql'])
	);
