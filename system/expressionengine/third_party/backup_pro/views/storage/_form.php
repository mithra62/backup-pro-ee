...
$this->table->add_row(
    ...
    form_input('storage_location_name', $form_data['storage_location_name'], 'id="storage_location_name"').$view_helper->m62FormErrors($form_errors['storage_location_name'])
);
...
$this->table->add_row(
    ...
    form_checkbox('storage_location_status', '1', $form_data['storage_location_status'], 'id="storage_location_status"').$view_helper->m62FormErrors($form_errors['storage_location_status'])
);
...
$this->table->add_row(
    ...
    form_checkbox('storage_location_file_use', '1', $form_data['storage_location_file_use'], 'id="storage_location_file_use"').$view_helper->m62FormErrors($form_errors['storage_location_file_use'])
);
...
$this->table->add_row(
    ...
    form_checkbox('storage_location_db_use', '1', $form_data['storage_location_db_use'], 'id="storage_location_db_use"').$view_helper->m62FormErrors($form_errors['storage_location_db_use'])
);
...
$this->table->add_row(
    ...
    form_checkbox('storage_location_include_prune', '1', $form_data['storage_location_include_prune'], 'id="storage_location_include_prune"').$view_helper->m62FormErrors($form_errors['storage_location_include_prune'])
);
