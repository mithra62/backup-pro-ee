...
$this->table->add_row(
    ...
    form_password('dropbox_access_token', $form_data['dropbox_access_token'], 'id="dropbox_access_token"').m62_form_errors($form_errors['dropbox_access_token'])
);
...
$this->table->add_row(
    ...
    form_password('dropbox_app_secret', $form_data['dropbox_app_secret'], 'id="dropbox_app_secret"').m62_form_errors($form_errors['dropbox_app_secret'])
);
...
$this->table->add_row(
    ...
    form_input('dropbox_prefix', $form_data['dropbox_prefix'], 'id="dropbox_prefix"').m62_form_errors($form_errors['dropbox_prefix'])
);