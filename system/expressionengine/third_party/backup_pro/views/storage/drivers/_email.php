...
$this->table->add_row(
    ...
    form_textarea('email_storage_emails', $form_data['email_storage_emails'], 'id="email_storage_emails"').$view_helper->m62FormErrors($form_errors['email_storage_emails'])
);
...
$this->table->add_row(
    ...
    form_input('email_storage_attach_threshold', $form_data['email_storage_attach_threshold'], 'id="email_storage_attach_threshold"').$view_helper->m62FormErrors($form_errors['email_storage_attach_threshold'])
);