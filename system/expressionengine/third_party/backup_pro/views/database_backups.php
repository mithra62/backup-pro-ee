...
if(count($backups['database']) > 0): 
	...
	?>
	<?php else: ?>
		<div class="no_backup_found"><?php echo $view_helper->m62Lang('no_database_backups')?> <a href="<?php echo $nav_links['backup_db']; ?>"><?php echo $view_helper->m62Lang('would_you_like_to_backup_database_now')?></a></div>
	<?php endif; ?>
</div>
...
<div class="tableFooter">
	<div class="tableSubmit">
		<?php echo form_submit(array('name' => '_remove_backup_button', 'value' => $view_helper->m62Lang('delete_selected'), 'class' => 'submit', 'id' => '_remove_backup_button'));?>
	</div>
</div>	
<?php endif;?>
<?php echo form_close()?>